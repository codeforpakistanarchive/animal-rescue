...
right(1, '/', '', 'Welcome to Animal Rights Pakistan', '<p>Animal Rights Pakistan is a collaboratively edited <strong>question</strong> and <strong>answer</strong> site built to suit your needs.</p>\r\n\r\n<p>It''s easy to use, with no registration required!</p>\r\n\r\n<p><a href="<?php $_SERVER['PATH_INFO']?>co/questions/ask">ask a question</a></p>', 1);
